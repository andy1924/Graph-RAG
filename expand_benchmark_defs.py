"""
Expand benchmark questions and references for all 4 corpora to 15 questions each.
Overwrites comprehensive_evaluation.py and data_retriever.py with full expansions
to ensure exact content is applied without truncation.
