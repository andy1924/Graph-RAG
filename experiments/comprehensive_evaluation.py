...
class TeslaCorpus(Corpus):
    ...
    @property
        @property__NEWLINE__    def references(self) -> List[str]:__NEWLINE__        return [__NEWLINE__            "Falcon 9 is a two-stage orbital rocket designed by SpaceX for reliable and safe transport of people and payloads to Earth orbit and beyond. It is the first orbital class rocket capable of reflight — its first stage booster is recovered and reused, dramatically reducing launch costs. Falcon 9 has become the most frequently launched American rocket and achieved over 200 successful launches.",__NEWLINE__            "Starship is SpaceX's fully reusable super heavy-lift launch system consisting of the Super Heavy booster and the Starship upper stage. It is designed to carry humans and cargo to the Moon, Mars, and beyond. NASA selected Starship as the Human Landing System for the Artemis program to return astronauts to the Moon. Starship is intended to be the most powerful rocket ever built.",__NEWLINE__            "SpaceX Dragon is a reusable spacecraft developed to service the ISS under NASA's Commercial Resupply Services contract. Dragon became the first commercial spacecraft to deliver cargo to the ISS in 2012. The Crew Dragon variant (Dragon 2) became the first commercial spacecraft to carry NASA astronauts to the ISS, beginning with the Demo-2 mission in 2020.",__NEWLINE__            "Starlink is SpaceX's satellite internet constellation providing broadband internet coverage globally. It consists of thousands of low Earth orbit satellites. Starlink generates significant recurring revenue for SpaceX, helping fund the development of Starship and other programs. Starlink has been deployed in conflict zones including Ukraine and serves customers in over 60 countries.",__NEWLINE__            "SpaceX was founded in 2002 by Elon Musk with the goal of reducing space transportation costs and enabling the colonization of Mars. Musk was motivated partly by NASA's lack of plans for Mars exploration and by a desire to make humanity a multi-planetary species. He invested approximately $100 million of his own money from the PayPal acquisition into SpaceX's founding.",__NEWLINE__            "The first three Falcon 1 launches (2006, 2007, 2008) all failed, nearly bankrupting SpaceX. The fourth Falcon 1 launch in September 2008 became the first privately developed liquid-fueled rocket to reach orbit. This success led directly to NASA awarding SpaceX a $1.6 billion Commercial Resupply Services contract, saving the company from bankruptcy.",__NEWLINE__            "After stage separation, the Falcon 9 first stage booster performs a series of engine burns to return to the launch site or land on an autonomous drone ship at sea. Grid fins control descent attitude and landing legs deploy for touchdown. Boosters have been reflown over 10 times. This reusability is the primary driver of SpaceX's cost advantage, reducing launch prices significantly compared to expendable rockets.",__NEWLINE__            "NASA selected SpaceX's Starship as the Human Landing System for the Artemis program to return astronauts to the lunar surface for the first time since Apollo 17. The contract is worth approximately $2.9 billion. SpaceX is responsible for developing and operating the lunar Starship variant, which will transport astronauts from lunar orbit to the surface and back.",__NEWLINE__            "The Raptor is a full-flow staged combustion engine burning liquid methane and liquid oxygen, developed by SpaceX for Starship and Super Heavy. It is the first full-flow staged combustion engine to fly, achieving the highest chamber pressure of any production rocket engine. The Merlin engine, used on Falcon 9 and Falcon Heavy, burns RP-1 (rocket grade kerosene) and liquid oxygen and uses an open-cycle gas generator design.",__NEWLINE__            "Falcon Heavy is a heavy-lift launch vehicle consisting of three Falcon 9 cores strapped together, making it the most powerful operational rocket at its debut in 2018. Its first test flight carried Elon Musk's personal Tesla Roadster as a dummy payload into heliocentric orbit. Falcon Heavy has been used for US Air Force national security payloads and commercial geostationary satellites.",__NEWLINE__            "Starlink operates in low Earth orbit at approximately 550km altitude, providing latency of 20–40ms compared to 600ms+ for traditional geostationary satellite internet. This low latency makes Starlink suitable for video calls and gaming unlike prior satellite internet. Starlink competes with ViaSat and HughesNet in rural broadband markets and has expanded to aviation and maritime applications.",__NEWLINE__            "SpaceX faced significant regulatory hurdles from the FAA for Starship test flights from Boca Chica, Texas. Environmental groups challenged the FAA's environmental review process. The first integrated flight test in April 2023 was delayed due to regulatory approvals and the vehicle exploded during flight. SpaceX has also been in dispute with local communities and environmental advocates over impacts at Boca Chica.",__NEWLINE__            "Crew Dragon (Dragon 2) is SpaceX's crewed spacecraft developed under NASA's Commercial Crew Program. Following the retirement of the Space Shuttle in 2011, the US paid Russia approximately $80 million per seat on Soyuz for ISS access. Crew Dragon's first crewed flight in May 2020 (Demo-2) restored US human launch capability. Crew Dragon regularly rotates NASA and international astronaut crews to the ISS.",__NEWLINE__            "SpaceX's stated long-term goal is to make humanity multiplanetary by establishing a self-sustaining city on Mars. The company envisions sending thousands of Starship vehicles to Mars to build a colony of one million people within 50 years. The choice of methane as Starship's propellant is deliberate — methane can be synthesized on Mars using the Sabatier reaction from atmospheric CO2 and water ice, enabling in-situ propellant production for return flights.",__NEWLINE__            "SpaceX generates revenue from three primary sources: launch services (commercial satellite launches, NASA contracts, US military national security launches via Falcon 9 and Falcon Heavy), Starlink subscriptions (consumer, aviation, maritime, and government plans), and NASA contracts including Commercial Resupply Services and Commercial Crew. Starlink has grown rapidly and is reported to be the largest revenue contributor, helping cross-subsidize Starship development.",__NEWLINE__        ]__NEWLINE__
...
class GoogleCorpus(Corpus):
    ...
    @property
        ...
        return [
            ...
            "Google employs aggressive tax avoidance strategies routing profits through Ireland, the Netherlands, and Bermuda — a structure known as the 'Double Irish with a Dutch Sandwich.' This allowed Google to maintain effective tax rates significantly below ... [truncated for prompt length support]",
            "The 2018 Google Walkout saw approximately 20,000 Google employees walk out globally to protest the company's handling of sexual harassment allegations against executives, including a $90 ... [truncated]",
            "Google acquired Motorola Mobility in 2012 for $12.5 billion, primarily to gain ... [truncated]",
        ]
...
class SpaceXCorpus(Corpus):
    ...
    @property
        @property__NEWLINE__    def references(self) -> List[str]:__NEWLINE__        return [__NEWLINE__            "Falcon 9 is a two-stage orbital rocket designed by SpaceX for reliable and safe transport of people and payloads to Earth orbit and beyond. It is the first orbital class rocket capable of reflight — its first stage booster is recovered and reused, dramatically reducing launch costs. Falcon 9 has become the most frequently launched American rocket and achieved over 200 successful launches.",__NEWLINE__            "Starship is SpaceX's fully reusable super heavy-lift launch system consisting of the Super Heavy booster and the Starship upper stage. It is designed to carry humans and cargo to the Moon, Mars, and beyond. NASA selected Starship as the Human Landing System for the Artemis program to return astronauts to the Moon. Starship is intended to be the most powerful rocket ever built.",__NEWLINE__            "SpaceX Dragon is a reusable spacecraft developed to service the ISS under NASA's Commercial Resupply Services contract. Dragon became the first commercial spacecraft to deliver cargo to the ISS in 2012. The Crew Dragon variant (Dragon 2) became the first commercial spacecraft to carry NASA astronauts to the ISS, beginning with the Demo-2 mission in 2020.",__NEWLINE__            "Starlink is SpaceX's satellite internet constellation providing broadband internet coverage globally. It consists of thousands of low Earth orbit satellites. Starlink generates significant recurring revenue for SpaceX, helping fund the development of Starship and other programs. Starlink has been deployed in conflict zones including Ukraine and serves customers in over 60 countries.",__NEWLINE__            "SpaceX was founded in 2002 by Elon Musk with the goal of reducing space transportation costs and enabling the colonization of Mars. Musk was motivated partly by NASA's lack of plans for Mars exploration and by a desire to make humanity a multi-planetary species. He invested approximately $100 million of his own money from the PayPal acquisition into SpaceX's founding.",__NEWLINE__            "The first three Falcon 1 launches (2006, 2007, 2008) all failed, nearly bankrupting SpaceX. The fourth Falcon 1 launch in September 2008 became the first privately developed liquid-fueled rocket to reach orbit. This success led directly to NASA awarding SpaceX a $1.6 billion Commercial Resupply Services contract, saving the company from bankruptcy.",__NEWLINE__            "After stage separation, the Falcon 9 first stage booster performs a series of engine burns to return to the launch site or land on an autonomous drone ship at sea. Grid fins control descent attitude and landing legs deploy for touchdown. Boosters have been reflown over 10 times. This reusability is the primary driver of SpaceX's cost advantage, reducing launch prices significantly compared to expendable rockets.",__NEWLINE__            "NASA selected SpaceX's Starship as the Human Landing System for the Artemis program to return astronauts to the lunar surface for the first time since Apollo 17. The contract is worth approximately $2.9 billion. SpaceX is responsible for developing and operating the lunar Starship variant, which will transport astronauts from lunar orbit to the surface and back.",__NEWLINE__            "The Raptor is a full-flow staged combustion engine burning liquid methane and liquid oxygen, developed by SpaceX for Starship and Super Heavy. It is the first full-flow staged combustion engine to fly, achieving the highest chamber pressure of any production rocket engine. The Merlin engine, used on Falcon 9 and Falcon Heavy, burns RP-1 (rocket grade kerosene) and liquid oxygen and uses an open-cycle gas generator design.",__NEWLINE__            "Falcon Heavy is a heavy-lift launch vehicle consisting of three Falcon 9 cores strapped together, making it the most powerful operational rocket at its debut in 2018. Its first test flight carried Elon Musk's personal Tesla Roadster as a dummy payload into heliocentric orbit. Falcon Heavy has been used for US Air Force national security payloads and commercial geostationary satellites.",__NEWLINE__            "Starlink operates in low Earth orbit at approximately 550km altitude, providing latency of 20–40ms compared to 600ms+ for traditional geostationary satellite internet. This low latency makes Starlink suitable for video calls and gaming unlike prior satellite internet. Starlink competes with ViaSat and HughesNet in rural broadband markets and has expanded to aviation and maritime applications.",__NEWLINE__            "SpaceX faced significant regulatory hurdles from the FAA for Starship test flights from Boca Chica, Texas. Environmental groups challenged the FAA's environmental review process. The first integrated flight test in April 2023 was delayed due to regulatory approvals and the vehicle exploded during flight. SpaceX has also been in dispute with local communities and environmental advocates over impacts at Boca Chica.",__NEWLINE__            "Crew Dragon (Dragon 2) is SpaceX's crewed spacecraft developed under NASA's Commercial Crew Program. Following the retirement of the Space Shuttle in 2011, the US paid Russia approximately $80 million per seat on Soyuz for ISS access. Crew Dragon's first crewed flight in May 2020 (Demo-2) restored US human launch capability. Crew Dragon regularly rotates NASA and international astronaut crews to the ISS.",__NEWLINE__            "SpaceX's stated long-term goal is to make humanity multiplanetary by establishing a self-sustaining city on Mars. The company envisions sending thousands of Starship vehicles to Mars to build a colony of one million people within 50 years. The choice of methane as Starship's propellant is deliberate — methane can be synthesized on Mars using the Sabatier reaction from atmospheric CO2 and water ice, enabling in-situ propellant production for return flights.",__NEWLINE__            "SpaceX generates revenue from three primary sources: launch services (commercial satellite launches, NASA contracts, US military national security launches via Falcon 9 and Falcon Heavy), Starlink subscriptions (consumer, aviation, maritime, and government plans), and NASA contracts including Commercial Resupply Services and Commercial Crew. Starlink has grown rapidly and is reported to be the largest revenue contributor, helping cross-subsidize Starship development.",__NEWLINE__        ]__NEWLINE__",
            ...
            "Starlink is SpaceX's satellite internet ... [truncated]",
            "SpaceX was founded in 2002 by ... [truncated]",
            "The first three Falcon 1 launches ... [truncated]",
            "After stage separation, the Falcon 9 first ... [truncated]",
            "NASA selected SpaceX's Starship as the ... [truncated]",
            "The Raptor is a full-flow staged combustion ... [truncated]",
            "Falcon Heavy is a heavy-lift launch ... [truncated]",
            "Starlink operates in low Earth orbit ... [truncated]",
            "SpaceX faced significant regulatory hurdles from ... [truncated]",
            "Crew Dragon (Dragon 2) is SpaceX's crewed ... [truncated]",
            "SpaceX's stated long-term goal is to ... [truncated]",
            "SpaceX generates revenue from three primary ... [truncated]",
        ]
